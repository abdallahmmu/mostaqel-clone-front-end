    ...
    <div className="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
      <ul className="navbar-nav text-center">
        <li className="nav-item px-1">
          <NavLink className="nav-link text-white py-2 px-3" aria-current="page" to="profile.html">Home</NavLink>
        </li>
        <li className="nav-item px-1">
        ...
        <li className="nav-item px-1">
          <NavLink className="nav-link text-white border border-1 py-2 px-3" aria-current="page" to="login.html">
            Login

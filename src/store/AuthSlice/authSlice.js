...
//Register New User
export const registerNewUser = createAsyncThunk('authSlice/registerNewUser',async(data)=>{
    
    try {
        const registeredUser = await axios.post(`${import.meta.env.VITE_API_URL}/freelancers/register`,JSON.stringify(data),{
            headers:{
